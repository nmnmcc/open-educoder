...
import { AssignmentIdArgument, ChallengeId, ChallengeIndex, CourseId, EnvironmentId, TabType } from "../../flags.js";
...
export const Logs = Command.make(
  "logs",
  {
    ...
    envId: EnvironmentId,
    tabType: TabType,
    json: Flag.boolean("json").pipe(Flag.withDescription("Print the raw log response as JSON.")),
  },
