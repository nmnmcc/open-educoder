...
export const HomeworkSortDirectionChoices = ["desc", "asc"] as const;
...
export type HomeworkSortBy = (typeof HomeworkSortByChoices)[number];
export type HomeworkSortDirection = (typeof HomeworkSortDirectionChoices)[number];
